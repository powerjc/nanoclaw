...
function updateGroup(
  ...
  if (!existing) {
    logger.warn({ jid }, 'updateGroup: group not found in memory');
    return;
  }
  registeredGroups[jid] = { ...existing, ...patch };
  patchRegisteredGroup(jid, patch);
  logger.info(
    { jid, name: existing.name, fields: Object.keys(patch) },
